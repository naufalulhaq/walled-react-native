  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        >
            {/* input destination */}
            <View style={{flexDirection: "row", justifyContent: "space-between", gap: 8, alignItems: "center", height: 52, backgroundColor: "#19918F", paddingHorizontal: 24}}>
                <Text style={{color: "white", fontSize: 24}}>To:</Text>
                <TextInput style={{color: "white", fontSize: 24, flex: 1}} placeholder="9000008940208" placeholderTextColor="white"></TextInput>
            </View>
          {/* input amount */}
          <View
            style={{
          ...
          >
            ...
            <View style={{flexDirection: "row", justifyContent: "space-between"}}>
                <Text style={{color: "#B3B3B3", fontSize: 16}}>Balance</Text>
                <Text style={{color: "#19918F", fontSize: 16}}>IDR 10.000.000</Text>
            </View>
          </View>
          {/* input notes */}
          <View
